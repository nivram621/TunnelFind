...
@implementation FranceViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = self.franceString;
...
- (void)fetchedData:(NSData *)responseData {
    ...
    json = [json sortedArrayUsingDescriptors:[NSArray arrayWithObjects:nameSorter,priceSorter,bookingSorter,countrySorter,openedSorter,yearopenedSorter,manufacturerSorter,tunneltypeSorter,flightchamberstyleSorter,flightchamberdiameterSorter,flightchamberheightSorter,topwindspeedSorter,offpeakpricingSorter,onpeakpricingSorter,hoursSorter,websiteurlSorter,imagetunnelSorter,flagSorter,nil]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.country.text isEqualToString:self.franceString]) {
        cell.hidden = NO;
    } else {
        cell.hidden = YES;
    }
